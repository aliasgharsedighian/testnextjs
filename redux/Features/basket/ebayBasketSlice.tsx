...
export const ebayBasketSlice = createSlice({
  name: "ebayBasket",
  initialState,
  reducers: {
...
export const {
  ...
  incrementQuantity,
  decrementQuantity,
} = ebayBasketSlice.actions;

export const ebaySelectItems = (state: any) => state.ebayBasket.items;
export const ebaySelectTotal = (state: any) =>
  state.ebayBasket.items.reduce(
    (total: any, item: any) => total + item.price * item.quantity,
    0
  );
// export const cartOpen = (state) => state.basket.cartOpen;

export default ebayBasketSlice.reducer;
