...
export const amazonBasketSlice = createSlice({
  name: "amazonBasket",
  initialState,
  reducers: {
...
export const {
  ...
  incrementQuantity,
  decrementQuantity,
} = amazonBasketSlice.actions;

export const amazonSelectItems = (state: any) => state.amazonBasket.items;
export const amazonSelectTotal = (state: any) =>
  state.amazonBasket.items.reduce(
    (total: any, item: any) => total + item.price * item.quantity,
    0
  );
// export const cartOpen = (state) => state.basket.cartOpen;

export default amazonBasketSlice.reducer;
