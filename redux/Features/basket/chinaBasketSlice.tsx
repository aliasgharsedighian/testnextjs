...
export const chinaBasketSlice = createSlice({
  name: "chinaBasket",
  initialState,
  reducers: {
...
export const {
  ...
  incrementQuantity,
  decrementQuantity,
} = chinaBasketSlice.actions;

export const chinaSelectItems = (state: any) => state.chinaBasket.items;
export const chinaSelectTotal = (state: any) =>
  state.chinaBasket.items.reduce(
    (total: any, item: any) => total + item.price * item.quantity,
    0
  );
// export const cartOpen = (state) => state.basket.cartOpen;

export default chinaBasketSlice.reducer;
