...
export const emirateBasketSlice = createSlice({
  name: "emirateBasket",
  initialState,
  reducers: {
...
export const {
  ...
  incrementQuantity,
  decrementQuantity,
} = emirateBasketSlice.actions;

export const emirateSelectItems = (state: any) => state.emirateBasket.items;
export const emirateSelectTotal = (state: any) =>
  state.emirateBasket.items.reduce(
    (total: any, item: any) => total + item.price * item.quantity,
    0
  );
// export const cartOpen = (state) => state.basket.cartOpen;

export default emirateBasketSlice.reducer;
